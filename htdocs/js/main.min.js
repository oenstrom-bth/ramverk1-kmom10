...
function toggleNavbar() {document.body.classList.toggle("no-scroll");document.getElementById("navbar").classList.toggle("show");document.getElementById("overlay").classList.toggle("show");}
document.addEventListener("DOMContentLoaded", function() {document.getElementById("menu-button").addEventListener("click", toggleNavbar);document.getElementById("overlay").addEventListener("click", toggleNavbar);});
